...
const dateChosen = flatpickr(dateInput, {
    ...
    onClose: function onDateClose(selectedDate) {
        const dateChosen1 = new Date(selectedDate[0]);
        const dateCurrent = new Date();
        if (dateChosen1.getTime() <= dateCurrent.getTime()) {
...
function onDateBtnClick(chosenDate) {
    ...
    if (chosenTime.getTime() < currentTime1.getTime()) {
        (0, _notiflixNotifyAio.Notify).failure("Please choose a date in the future");
        return;
    }
    timeCounter.timeInMs = chosenTime.getTime() - currentTime1.getTime();
    timerId = setInterval(()=>{
...
},{"flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"llQu5":[function(require,module,exports) {
